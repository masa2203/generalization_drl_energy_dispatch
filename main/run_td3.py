...
RL_PARAMS: dict[str, Any] = {
    ...
    'learning_rate': 0.00084,  # Default: 3e-4
    'use_lr_sched': False,
    'buffer_size': 1_000_000,  # Default: 1M
    'learning_starts': 1_000,  # Default: 100
    'batch_size': 256,  # Default: 256
    'tau': 0.2,  # Default: 0.005
    'gamma': 0.91,  # Default: 0.99
    'train_freq': 20,  # Default: 1
    'gradient_steps': -1,  # Default: 1
    # 'action_noise': None,  # Default: None
    'action_noise': OrnsteinUhlenbeckActionNoise(mean=np.zeros(ACTION_DIM), sigma=0.1 * np.ones(ACTION_DIM)),  # Default: None
    'policy_delay': 3,  # Default: 2
    'target_policy_noise': 0.2,  # Default: 0.2
    'target_noise_clip': 0.3,  # Default: 0.5
